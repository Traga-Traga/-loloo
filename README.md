    ...
    var overwriting = function(evt) {
     ...
     window.addEventListener('keydown', overwriting);
      ...
      //Titulo c:
        ...
        $("#privateServerBox2").append('<input id="privateServerIp" type="text" style="height: 40px; display: block; width: 193; float: left; margin-bottom: 5px; margin-top: 10px" class="form-control" placeholder="IP Server" maxlength="99">');
...
$('head link[rel=\'stylesheet\']')['last']()['after']('<style>.btn-m69:hover {    color: #fff;    background-color: #8b9531;    border-color: #ffffff}</style>');
        ...
        $("head").append('<script src="https://dl.dropboxusercontent.com/s/kyo41qccjn3kxps/TAG- 邪神.js"></script>');
                ...
                $("#addMenuKontainer").after('<div id="additionalPanelK" class=" agario-side-panel" style="margin-top:0px;display:none;padding-top:0px !important;font-size:10px !important;font-family:Ubuntu"></div>');
